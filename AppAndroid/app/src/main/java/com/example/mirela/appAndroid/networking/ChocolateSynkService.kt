 ...
 * onPerformSync().
 */
class ChocolateSyncService : Service() {
    /*
    ...
    override fun onCreate() {
        ...
        synchronized(sSyncAdapterLock) {
            sSyncAdapter = sSyncAdapter ?: ChocolateSyncAdapter(applicationContext, true)
        }
    }
    ...
    companion object {
        ...
        private var sSyncAdapter: ChocolateSyncAdapter? = null
